...
# from langchain_community.vectorstores import FAISS  # Updated import for vector store
# from langchain.chains import RetrievalQA
# from langchain_huggingface import HuggingFacePipeline  # Updated import for Hugging Face pipeline
...
#     hf_pipeline = pipeline('text-generation', model='gpt2', max_length=500, truncation=True)  # Added truncation=True
...
#             break
#         answer = qa.invoke(question)  # Use invoke() instead of run()
#         print("\nAnswer:", answer)
